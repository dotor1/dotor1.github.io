...
function init_scs(){
	...
	let my_debug_info = [
			{h1:'데탑 마우스포인터(SCS)'	, h2:'offsetX'  , id:'debug_offsetX'},
	...
	let env_config={
		...
		width:400,
		//width:490,	//Mobile에서 화면에 꽉차는거
		//width:674,		//Desktop에서 스크롤바가 없는 위치까지
		height:400,
		...
		//Xaxis_grid_size:0.5,		//ctcs기준(ctcs에서, 1unit마다 grid를 그린다)
		//Yaxis_grid_size:0.5,		//ctcs기준 
