...
class scUtil{
	...
	//{{2022.08.12 - dictionary search if property == 
	static dictionary_search_by_property_match(p_obj,p_property,p_value){
		let key = Object.keys(p_obj).find(key => p_obj[key][p_property] === p_value);
		return p_obj[key];
	}
